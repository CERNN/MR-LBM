...
#define M_OFFSET M_MZZ_INDEX
    ...
    constexpr int A_XX_CX_INDEX  = (3+M_OFFSET);
    constexpr int A_XX_CY_INDEX  = (4+M_OFFSET);
    constexpr int A_XX_CZ_INDEX  = (5+M_OFFSET);
    #ifdef M_OFFSET
        #undef M_OFFSET
    #endif
    ...
    constexpr int A_XY_CX_INDEX  = (3+M_OFFSET);
    constexpr int A_XY_CY_INDEX  = (4+M_OFFSET);
    constexpr int A_XY_CZ_INDEX  = (5+M_OFFSET);
    #ifdef M_OFFSET
        #undef M_OFFSET
    #endif
    ...
    constexpr int A_XZ_CX_INDEX  = (3+M_OFFSET);
    constexpr int A_XZ_CY_INDEX  = (4+M_OFFSET);
    constexpr int A_XZ_CZ_INDEX  = (5+M_OFFSET);
    #ifdef M_OFFSET
        #undef M_OFFSET
    #endif
    ...
    constexpr int A_YY_CX_INDEX  = (3+M_OFFSET);
    constexpr int A_YY_CY_INDEX  = (4+M_OFFSET);
    constexpr int A_YY_CZ_INDEX  = (5+M_OFFSET);
    #ifdef M_OFFSET
        #undef M_OFFSET
    #endif
    ...
    constexpr int A_YZ_CX_INDEX  = (3+M_OFFSET);
    constexpr int A_YZ_CY_INDEX  = (4+M_OFFSET);
    constexpr int A_YZ_CZ_INDEX  = (5+M_OFFSET);
    #ifdef M_OFFSET
        #undef M_OFFSET
    #endif
    ...
    constexpr int A_ZZ_CX_INDEX  = (3+M_OFFSET);
    constexpr int A_ZZ_CY_INDEX  = (4+M_OFFSET);
    constexpr int A_ZZ_CZ_INDEX  = (5+M_OFFSET);
    #ifdef M_OFFSET
        #undef M_OFFSET
    #endif
